...
public class AnnPermission {
    private final Context mContext;
//    private static AnnPermission mInstance;
    ...
    private String[] mNormalPermissions = {
            WRITE_EXTERNAL_STORAGE, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION,READ_PHONE_STATE,READ_EXTERNAL_STORAGE};
    private int[] mNormalPermissionIconRes = {
            R.drawable.permission_ic_storage, R.drawable.permission_ic_location, R.drawable.permission_ic_phone};
    private int mFilterColor = 0;
    private int mAnimStyleId = -1;

    public static AnnPermission create(Context context) {
        return new AnnPermission(context);
    }

    public AnnPermission(Context context) {
        mContext = context;
        mNormalPermissionNames = mContext.getResources().getStringArray(R.array.permissionNames);
    }

    public AnnPermission title(String title) {
        mTitle = title;
        return this;
    }

    public AnnPermission msg(String msg) {
        mMsg = msg;
        return this;
    }

    public AnnPermission permissions(List<PermissionItem> permissionItems) {
        mCheckPermissions = permissionItems;
        return this;
    }

    public AnnPermission filterColor(int color) {
        mFilterColor = color;
        return this;
    }

    public AnnPermission animStyle(int styleId) {
        mAnimStyleId = styleId;
        return this;
    }

    public AnnPermission style(int styleResIdsId) {
