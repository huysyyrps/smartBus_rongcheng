...
public class QuickAction extends PopupWindows implements OnDismissListener {
	 ...
	 public QuickAction(Context paramContext, int paramInt)
	  {
	    ...
	    if (this.mOrientation == 0)
	      setRootViewId(R.layout.popup_horizontal);
	    	...
	    	System.out.println("========"+R.layout.popup_vertical);
	...
	public void addActionItem(ActionItem action) {
		...
		{
			View view = mInflater.inflate(R.layout.horiz_separator, null);
			view.setLayoutParams(new android.widget.RelativeLayout.LayoutParams(-2, -1));
	...
	private void showArrow(int whichArrow, int requestedX) {
        ...
        param.leftMargin = requestedX/2 - arrowWidth / 2;
