        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.CountDownProgressBar_countDown_centerTextSize:
                    centerTextSize = ta.getDimensionPixelSize(attr, (int) dip2px(30)); // 默认中间文字字体大小为40dp
                    break;
...
//        int minHedight = Math.min(heightPixels, hedight);
    ...
    private void drawCircle(Canvas canvas, int center, int radius) {
        ...
        circlePaint.setShadowLayer(0, 0, 0, Color.BLUE);
...
//            percent = (result / 60 < 10 ? "0" + result / 60 : result / 60) + ":" + (result % 60 < 10 ? "0" + result % 60 : result % 60);
            percent = (result % 60 < 10 ? "0" + result % 60 : result % 60)+"";
