...
public class CustomizedDemandListPresenter implements CustomizedLinesContract.presenter {
    private Context context;
    private CustomizedLinesContract.View view;

    public CustomizedDemandListPresenter(Context context, CustomizedLinesContract.View view) {
