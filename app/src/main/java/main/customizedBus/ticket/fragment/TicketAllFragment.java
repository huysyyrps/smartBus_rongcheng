...
public class TicketAllFragment extends Fragment implements CustomizedTicketListContract.View {
...
//   private List<>
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_all_ticket,container,false);
        initView(view);
