...
public class TicketRetundFragment extends Fragment  implements CustomizedTicketListContract.View {
   ...
   private StandbyTicketFragmentAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_refund_ticket,container,false);
        initView(view);
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(),DividerItemDecoration.VERTICAL));
    ...
    private  void getTicketListFromNet(){
       ...
       param.put("Passenger", PublicData.userAccount);
        ...
        param.put("mobileStatus", 6);//0�������У�1�������У�2���ѹ��ڣ�3������Ʊ��4���˿����ˣ�5���˿��У�6�����˿7���˿�ʧ��
