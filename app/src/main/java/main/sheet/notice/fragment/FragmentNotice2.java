...
public class FragmentNotice2 extends Fragment implements NoticeContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noticePresenter.getNotice("1", "10", "3002");
    ...
    private void setClient() {
        recyclerView.setOnLoadListener(new CustomRefreshView.OnLoadListener() {
            ...
            public void onLoadMore() {
                page++;
                noticePresenter.getNotice(String.valueOf(page), "10", "3002");
            }
        });
    }
