...
public class ConstData {
	...
	public final static String ICRechargene = "https://rcbus.org.cn:50013/";
	...
	public static double CENTER_X = 118.503f;
	public static double CENTER_Y = 31.6899f;
	public static double GPS_X = 00.0F;//γ��
	public static double GPS_Y = 00.0F;//����
	//��λ�ĳ���
	...
	public static LatLng startne;//����Ŀ�ʼվ��

	public static LatLng endne;//����Ľ���վ��
		
	public static String tab;//������ѡ�е�ѡ�
	
	public static String imei;
	
	public static String help="��ϵͳ��Ϣ����Ϊ�˳��ο�ʹ�ã�����������������ҵ��;";
	
	public static int onBus=0;//ѡ����ϳ�վ��
	
	public static int upBus=0;//ѡ����³�վ��
	
	public static String BusCode=""; //ѡ��ĳ�������
	
	public static boolean bLoadMenu= false; //ѡ��ĳ�������
	//�����Ϣ
	public static HashMap<String, AdvertBean> adPageMap = new HashMap<String, AdvertBean>();
	//�Ƿ���¹��ͼ��
	...
	public static Map<String, com.baidu.mapapi.model.LatLng> latlngMap;
	public static String ishavenew="true";
	public static String appLatestTimeStampStr="";
	...
	public static String Ip ="117.158.56.11"; //go服务器Ip
	public static String Port ="50020";//go服务器端口 ，socket

//	public static String Ip ="123.232.38.10"; //go服务器Ip
//	public static String Port ="258";//go服务器端口 ，socket
//	public static String Port ="12345";//go服务器端口 ，socket65002
	...
	public static List<String> timeTable=new ArrayList<String>();
	public static com.baidu.mapapi.model.LatLng start;//点击的开始站点
	public static com.baidu.mapapi.model.LatLng end;//点击的结束站点


	public static String startStudia;//开始站点

	public static String endStudia;//结束站点
	 ...
	 * @return 加密数据
	 */
	public static byte[] getEncryptBags(String cardNo,String Random,int defaultSum){
		int pos=0;
		//封装登录包
...
//      先取卡号，不足32位前补0
		...
		Log.e("read", "readreadreadread"+strCardNo32);
...
//		String strLastRet = DesPBOC2.Encry3DESStrHex(strCardNo32.substring(16, 32), strKey);
		String strFirstRet="3000010101022122FF0000000000";
		String strLastRet=strCardNo32.substring(16, 32);
		String strLastRetrad="04"+Random+"04001A0000000000000000";
		...
		Log.e("read", defaultSum+"**6666666666666666666666666&&"+sbCharge);
		String lDateTime="02000000100001"+strCurDate;
		Log.e("read", strFirstRet + strLastRet+strLastRetrad+sbCharge+lDateTime);
		String aaa=strFirstRet + strLastRet+strLastRetrad+sbCharge+lDateTime;
		Log.e("read", aaa.length()+"");
//		byte[] fff=hexToByteArray(aaa);
//				for (int i=0;i<hexToByteArray(aaa).length;i++){
//					buffer[pos++] = fff[i];
//				}
		for (char c : (strFirstRet + strLastRet+strLastRetrad+sbCharge+lDateTime).toCharArray()) {
			buffer[pos++] = (byte) c;
			//Log.e("read", "**WWWWWWWWWWWWWWW&&"+pos);
		}
	...
	public static byte[] getLoginbudeng(String card){
		...
		//封装包头
		byte[] b1=getBagHeader(0xA0,55,0xD6,0);
		System.arraycopy(b1, 0, buffer, pos, b1.length);
		pos= b1.length;
		//预留字段
	...
	public static byte[] getLoginver(){
		...
		//封装包头
		byte[] b1=getBagHeader(0xA0,35,0xD6,0);
		System.arraycopy(b1, 0, buffer, pos, b1.length);
		pos= b1.length;
		//预留字段
		byte[] b2=getBagData(1, 0);
	 ...
	 * 登陆类型
	 */
	public static byte[] usepwd(String username, String pwd){

		String last=username+";"+pwd;
		byte b[] = last.getBytes();//String转换为byte[]
	...
	public static byte[] ver(String verrr){

		byte b[] = verrr.getBytes();//String转换为byte[]
		System.out.println(b);
		return b;
	}
