...
public class PullHeaderLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    final static int ACTION_BUTTON_CENTER = UIUtils.dpToPx(50);
    final static int ACTION_ICON_SIZE = UIUtils.dpToPx(82);
    private final static int DEFAULT_EXPAND = UIUtils.dpToPx(250);
    private final static int DEFAULT_HEIGHT = UIUtils.dpToPx(200);
    private final static int DEFAULT_SHRINK = UIUtils.dpToPx(68);
