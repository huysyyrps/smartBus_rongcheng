package main.flyrefresh.internal;
...
import main.flyrefresh.IPullHeader;
import main.flyrefresh.PullHeaderLayout;
...
//    private static final int COLOR_BACKGROUND = Color.parseColor("#1576fe");
...
//    private static final int COLOR_TREE_3_BTRUNK = Color.parseColor("#62A4AD");
    ...
    private static final int COLOR_BACKGROUND = Color.parseColor("#00ffffff");
    private static final int COLOR_MOUNTAIN_1 = Color.parseColor("#00ffffff");
    private static final int COLOR_MOUNTAIN_2 = Color.parseColor("#00ffffff");
    private static final int COLOR_MOUNTAIN_3 = Color.parseColor("#00ffffff");
    private static final int COLOR_TREE_1_BRANCH = Color.parseColor("#00ffffff");
    private static final int COLOR_TREE_1_BTRUNK = Color.parseColor("#00ffffff");
    private static final int COLOR_TREE_2_BRANCH = Color.parseColor("#00ffffff");
    private static final int COLOR_TREE_2_BTRUNK = Color.parseColor("#00ffffff");
    private static final int COLOR_TREE_3_BRANCH = Color.parseColor("#00ffffff");
    private static final int COLOR_TREE_3_BTRUNK = Color.parseColor("#00ffffff");
