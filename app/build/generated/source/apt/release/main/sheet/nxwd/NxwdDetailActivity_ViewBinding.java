...
public class NxwdDetailActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public NxwdDetailActivity_ViewBinding(NxwdDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public NxwdDetailActivity_ViewBinding(NxwdDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    NxwdDetailActivity target = this.target;
